...
const cache_dir = GLib.get_user_cache_dir()
const additionalColorsPath = `${cache_dir}/material/colors.scss`

// Monitor the additionalColors file for changes
Utils.monitorFile(additionalColorsPath, (file, event) => {
